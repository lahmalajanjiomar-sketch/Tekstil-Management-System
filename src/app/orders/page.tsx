...
import { AuthContext, Order } from "@/context/auth-context"
...
function OrderTable({ status, searchQuery, sortOrder }: { status?: 'Sipariş Alındı' | 'Kargoya Verildi', searchQuery: string, sortOrder: string }) {
  ...
  if (!auth) return null
  const { orders, products, updateOrderStatus, deleteOrder, role } = auth
  ...
  }, [orders, status, searchQuery, sortOrder, products]);
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                              <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                      {t('confirm_delete_order_desc', { id: order.id.split('_')[1] })}
                                  </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
